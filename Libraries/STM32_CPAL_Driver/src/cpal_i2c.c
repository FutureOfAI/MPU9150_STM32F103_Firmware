...
uint32_t CPAL_I2C_Init(CPAL_InitTypeDef* pDevInitStruct) 
{
     ...
     || (pDevInitStruct->CPAL_State == CPAL_STATE_DISABLED))
  {
...
#ifndef CPAL_I2C_IT_PROGMODEL//run this line
...
#ifdef CPAL_I2C_DMA_PROGMODEL    //run this line
    ...
    ---------------------------------------------------------------------------*/   
    /* Enable I2Cx Device */
    __CPAL_I2C_HAL_ENABLE_DEV(pDevInitStruct->CPAL_Dev);//PB10 I2C2_SCL PB11 I2C2_SDA 
